...
map <silent> ,u :source ~/.vimrc " update the system settings from my vimrc file
map <silent> ,e :e ~/.vimrc      " edit my .vimrc file
...
silent only
cd ~/Desktop/omniplex/Plexon
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +87 __init__.py
badd +1 PlexClient.py
badd +1 TimeStampRead.py
badd +10 ../TimeStampRead.py
badd +18 testPlexUtil.py
badd +0 PlexUtil.py
args __init__.py
edit testPlexUtil.py
