...
class STAPanel(wx.Panel):
    ...
    def update_chart(self,data):
        ...
        if selected_unit:
            ...
            img = RevCorr.ParamMapIMG.get_rgb_img(data, channel, unit, tau=self.time/1000.0)
...
class MainFrame(wx.Frame):
    ...
    """
    def __init__(self):
        title = 'Spike Triggered Average(STA) - Parameter Mapping'
    ...
    def create_main_panel(self):
        ...
        self.sta_chart= STAPanel(self.panel, 'Parameter map')
